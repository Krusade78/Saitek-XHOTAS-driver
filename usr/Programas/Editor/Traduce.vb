Public Class Traduce
    ...
    Private Shared datos As DataSet = Nothing

    Public Shared Function Msg(ByVal id1 As String, ByVal id2 As String, ByVal tipo As Microsoft.VisualBasic.MsgBoxStyle) As Microsoft.VisualBasic.MsgBoxResult
...
da:
    ...
    Private Shared Function ExtraerCadena(ByVal ID As String, ByRef texto As String) As Boolean
        Dim app As Integer = datos.Tables.IndexOf("Editor")
