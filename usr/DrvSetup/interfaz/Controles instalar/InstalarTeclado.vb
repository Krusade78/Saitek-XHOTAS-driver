Public Class InstalarTeclado

    Private Declare Auto Function PrepararTeclados Lib "drvapi.dll" (ByVal hwnd As IntPtr) As Byte

    Private Sub InstalarTeclado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim ret As Byte = PrepararTeclados(ListBox1.Handle)
        Select Case (System.Globalization.CultureInfo.CurrentCulture.LCID And &HFF)
            ...
            Case &H10
                'nombre = "italian.xml"
            Case &HA
                Label1.Text = "Selecciona el teclado enchufado al X36F:"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            If ListBox1.SelectedIndex > -1 Then
                CType(Me.ParentForm, Form1).ProcesarTeclados(ListBox1.SelectedIndex)
            End If
        End If
    End Sub
