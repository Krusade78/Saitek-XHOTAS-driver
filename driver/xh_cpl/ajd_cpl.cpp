...
static  CPLPAGEINFO     grgcpInfo[NUMPAGES] = {
	{ MAKEINTRESOURCEW(IDD_X36PROP_PAGE1), X36PROP_Page1_DlgProc}
};

static WCHAR tit1[64];
static WCHAR tit2[64];
...
CDIGameCntrlPropSheet_X::~CDIGameCntrlPropSheet_X(void)
{
    ...
    // m_pdiDevice2
    if (NULL != m_pdiDevice8)
    {
        m_pdiDevice8->Unacquire();
        m_pdiDevice8->Release();
        m_pdiDevice8 = NULL;
    }
    // m_pdiJoyCfg
    if (NULL != m_pdiJoyCfg)
...
//************** X36 DRIVER ***********************
        m_pdigcPageInfo[i].fIconFlag     = FALSE;//TRUE;
        m_pdigcPageInfo[i].lpwszPageIcon = NULL;//MAKEINTRESOURCEW(IDI_CONFIG);
//*************************************************
		...
		m_pdigcPageInfo[i].lpwszPageTitle    = L"Saitek HOTAS";
    ...
    m_digcSheetInfo.lpwszSheetIcon      = MAKEINTRESOURCEW(IDI_SHEETICON);
    m_digcSheetInfo.lpwszSheetCaption   = L"Joystick CP";
...
//
//===========================================================================
STDMETHODIMP CDIGameCntrlPropSheet_X::SetDevice(IDirectInputDevice8* pdiDevice8)
{
    // store the device object ptr
    m_pdiDevice8 = pdiDevice8;
...
//
//===========================================================================
STDMETHODIMP CDIGameCntrlPropSheet_X::GetDevice(IDirectInputDevice8 **ppdiDevice8)
{

    // retrieve the device object ptr
    *ppdiDevice8 = m_pdiDevice8;
...
//
//===========================================================================
STDMETHODIMP CDIGameCntrlPropSheet_X::SetJoyConfig(IDirectInputJoyConfig8* pdiJoyCfg)
{
...
//
//===========================================================================
STDMETHODIMP CDIGameCntrlPropSheet_X::GetJoyConfig(IDirectInputJoyConfig8 **ppdiJoyCfg)
{
